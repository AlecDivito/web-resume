...
also mentioned poor text hierarchy and not very good font choice (not I
know that impact is not the best front to use).

\>

Because I am not a designer, understanding some of the feedback took a
bit of time. More so, I was rejecting it and resisting to suggestions.
Now, as I understand what I did wrong, and I was not listening to
designer friends, I will try my best not to do the same mistake again.
...
4.  Change the about page to include more professional, personal
    information
...
1.  Move data points, content and deployment to a 3^rd^ party service
    (using [wasmcompute](http://wasmcompute.com/))
...
I took "*inspirations*" from 2 websites. Website 1, and website 2.

\< insert quote about great artist stealing work \>
...
generated](media/image1.png){width="6.5in" height="3.10625in"}
