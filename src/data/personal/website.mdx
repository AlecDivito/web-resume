...
What really held me back the last time I took a stab at this was my designs and
planning because I had neither. This time I decided to take the time to just draw
out some of my ideas as well as define a small sitemap that would cover all
the sections of the site.

<div class="image--grid">
    <props.images.design_index_page alt=""/>
    <props.images.design_about_page alt=""/>
    <props.images.design_projects_page alt=""/>
    <props.images.design_work_page alt=""/>
    <props.images.design_contact_page alt=""/>
    <props.images.design_nav_component alt=""/>
</div>
