...
the fields on the lighthouse browser test. I also wanted to gain experince using
Indexdb as a way of keeping state on the client side as well as learning how to
create fun experinces using the browsers 2D engine, Canvas2d. The power of haveing
...
## Deign process
I'm not a designer but I tried to follow a workflow this project. I inital
...
![Bomb finders inital planning](../images/bomb-finder--inital-design.jpg)

![Bomb finders site map](../images/bomb-finder--sitemap.png)

After mapping out what files I wanted I got started creating the project. Initally
...
## Difficulties
While developing the game board I had a lot of animating pieces. Initally when I
started development I would call muiltiple draw calls to just draw one piece onto
the board. Of course this was over kill and ended up tanking perforamce when I
...
canvas. This was really good for perforamce but there was still lag on bigger
gameboards.
...
right very quickly. You'll see that there's a breif second where some rows of 
...
- Add way to turn off satified tiles handicap
...
to show people. I learned a lot about chrome dev tools and profiling my perforamce
...
- <a href="https://proxx.app" rel="noopener noreferrer" target="_blank">Proxx for the inital insperation</a>
- <a href="https://codepen.io" rel="noopener noreferrer" target="_blank">Codepen for UI element design insperation</a>
