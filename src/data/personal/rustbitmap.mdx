...
<div class="image--grid">
    ...
    <props.images.gradient_bilinear caption="Bilinear (300x300, 270.1MB)" alt="bilinear gradient" />
    <props.images.gradient_bicubic caption="Bicubic (300x300, 270.1MB)" alt="bicubic gradient" />
</div>
