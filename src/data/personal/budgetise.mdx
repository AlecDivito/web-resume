...
summarize and show what we learnt over the 3 year's while in the program. To 
complete the capstone my team had to ether choose a client from a list and hope we land the one we
picked or create our own project. My teammates and I decided we would want to try
and land the biggest project on the client list which was an owner of 12 franchise
stores for a fast food company. We landed it. The owner wanted to find a solution
that would allow him to track his expenses closer and get ride of his old workflow
of using spreadsheets. We came up with budgetise to solve his problem.
...
difficult to manage as well because it was hard to tell who had the most recent
copy. There was a lot of corrections needed because of mis-input so the sheets
always needed to be double checked because of inconsistencies that sometimes
arouse. Statistical gathering was another big issue, there was no easy way to
collect all of the stores historic data to try and discover deeper trends in
the data.
...
and our amazing presentations. At the showcase we were setup right next to the
...
![Winning second place at capstone showcase](../images/budgetise--win-second-place.jpg)

# Reflection

Overall I'm really happy with my team and the significant progress we made over
the 1 year development cycle of planning and prototyping diffrent UI layouts
and user experinces. I found that during each sprint we consistently delivered
on each week’s goals to the best of each of ours team member’s abilities. Coming
into our final term, my team members were at very different skill levels with
our core tech stack. Confronted with this challenge, I spent time and effort to
bring other members up to speed and reach reasonable productivity levels.

The team started off moving at a slow pace, but each week, the quality, volume
and velocity for which we ship new features and improvements has improved
drastically. The ability of each team member to estimate delivery times has also
progressed nicely.
